...
const T: Record<NativeLanguage, {
  ...
  ar: {
    welcome: 'مرحباً بك في WID 👋', sub: 'هذا البرنامج يساعدك في تعلم اللغة الألمانية والعثور على عمل. لديك ثلاثة تطبيقات.',
    codeLabel: 'كود WID الخاص بك', codeSub: 'احفظ هذا الكود — ستحتاجه في Linguu وJobMate',
    app1Title: 'WID — مركزك', app1Desc: 'تتبع تقدمك وتواصل مع منسقك',
    app2Title: 'Linguu — تعلم الألمانية', app2Desc: 'أدخل كود WID للمزامنة التلقائية',
    app3Title: 'JobMate — ابحث عن عمل', app3Desc: 'حسّن سيرتك الذاتية وتقدم للوظائف',
    cta: 'هيا نبدأ!',
  },
  uk: {
    welcome: 'Ласкаво просимо до WID 👋', sub: 'Ця програма допомагає вивчити німецьку та знайти роботу. У тебе є три застосунки.',
    codeLabel: 'Твій WID-код', codeSub: 'Збережи цей код — він потрібен у Linguu та JobMate',
    app1Title: 'WID — твій центр', app1Desc: 'Відстежуй прогрес, спілкуйся з координатором',
    app2Title: 'Linguu — вчи німецьку', app2Desc: 'Введи WID-код для автоматичної синхронізації',
    app3Title: 'JobMate — знайди роботу', app3Desc: 'Покращ резюме та подавай заявки',
    cta: 'Почнімо!',
  },
  es: {
    welcome: '¡Bienvenido a WID! 👋', sub: 'Este programa te ayuda a aprender alemán y encontrar trabajo. Tienes tres aplicaciones.',
    codeLabel: 'Tu código WID', codeSub: 'Guarda este código — lo necesitas en Linguu y JobMate',
    app1Title: 'WID — tu centro', app1Desc: 'Sigue tu progreso y comunícate con tu coordinador',
    app2Title: 'Linguu — aprende alemán', app2Desc: 'Ingresa el código WID para sincronización automática',
    app3Title: 'JobMate — encuentra trabajo', app3Desc: 'Mejora tu CV y postúlate a empleos',
    cta: '¡Empecemos!',
  },
  en: {
    welcome: 'Welcome to WID 👋', sub: 'This program helps you learn German and find a job. You have three apps.',
    codeLabel: 'Your WID code', codeSub: 'Save this code — you\'ll need it in Linguu and JobMate',
    app1Title: 'WID — your hub', app1Desc: 'Track your progress and connect with your coordinator',
    app2Title: 'Linguu — learn German', app2Desc: 'Enter your WID code for automatic sync',
    app3Title: 'JobMate — find a job', app3Desc: 'Improve your CV and apply to jobs',
    cta: "Let's go!",
  },
  ku: {
    welcome: 'Xêr hatî WID 👋', sub: 'Ev bername alîkariya fêrbûna Almanî û dîtina karê dike. Sê sepanên te hene.',
    codeLabel: 'Koda WID ya te', codeSub: 'Vê kodê hilîne — di Linguu û JobMate de pêwist e',
    app1Title: 'WID — navenda te', app1Desc: 'Pêşkeftina xwe bişopîne û bi hevrêzkerê xwe re têkilî dayne',
    app2Title: 'Linguu — Almanî hîn bibe', app2Desc: 'Koda WID binivîse ji bo hevdengkirina xweber',
    app3Title: 'JobMate — kar bibîne', app3Desc: 'CV-ya xwe baştir bike û serlêdanan bike',
    cta: 'Werin dest pê bikin!',
  },
  tr: {
    welcome: "WID'e Hoş Geldin 👋", sub: 'Bu program Almanca öğrenmene ve iş bulmana yardımcı olur. Üç uygulaман var.',
    codeLabel: 'WID kodun', codeSub: 'Bu kodu kaydet — Linguu ve JobMate\'de gerekecek',
    app1Title: 'WID — merkezin', app1Desc: 'İlerlemenizi takip et ve koordinatörünle iletişim kur',
    app2Title: 'Linguu — Almanca öğren', app2Desc: 'Otomatik senkronizasyon için WID kodunu gir',
    app3Title: 'JobMate — iş bul', app3Desc: 'CV\'ni geliştir ve işlere başvur',
    cta: 'Başlayalım!',
  },
  pl: {
    welcome: 'Witaj w WID 👋', sub: 'Ten program pomaga uczyć się niemieckiego i znaleźć pracę. Masz trzy aplikacje.',
    codeLabel: 'Twój kod WID', codeSub: 'Zapisz ten kod — będzie potrzebny w Linguu i JobMate',
    app1Title: 'WID — Twoje centrum', app1Desc: 'Śledź postępy i komunikuj się z koordynatorem',
    app2Title: 'Linguu — ucz się niemieckiego', app2Desc: 'Wpisz kod WID dla automatycznej synchronizacji',
    app3Title: 'JobMate — znajdź pracę', app3Desc: 'Ulepsz CV i aplikuj na oferty pracy',
    cta: 'Zaczynajmy!',
  },
  ro: {
    welcome: 'Bun venit la WID 👋', sub: 'Acest program te ajută să înveți germana și să găsești un loc de muncă. Ai trei aplicații.',
    codeLabel: 'Codul tău WID', codeSub: 'Salvează acest cod — ai nevoie de el în Linguu și JobMate',
    app1Title: 'WID — centrul tău', app1Desc: 'Urmărește progresul și comunică cu coordonatorul tău',
    app2Title: 'Linguu — învață germana', app2Desc: 'Introdu codul WID pentru sincronizare automată',
    app3Title: 'JobMate — găsește un loc de muncă', app3Desc: 'Îmbunătățește CV-ul și aplică la joburi',
    cta: 'Să începem!',
  },
  ru: {
    welcome: 'Добро пожаловать в WID 👋', sub: 'Эта программа поможет тебе выучить немецкий и найти работу. У тебя три приложения.',
    codeLabel: 'Твой WID-код', codeSub: 'Сохрани этот код — он нужен в Linguu и JobMate',
    app1Title: 'WID — твой центр', app1Desc: 'Отслеживай прогресс и общайся с координатором',
    app2Title: 'Linguu — учи немецкий', app2Desc: 'Введи WID-код для автоматической синхронизации',
